...
在文章的开头先回答一个问题。为什么这篇文章是旧事新说？因为一年前的这个时候 Travis CI 对于开源仓库的部署还是免费的，但在去年年底，官方更改了定价模式，对于免费用户到达一定的免费额度后必须交费才能继续享用服务。对目前的情况来说，我并不推荐使用 Travis CI 部署任何东西，更好的方法就是[使用 GitHub 自带的 Actions](/tech/website/deploy-hugo-with-github-actions/)。
