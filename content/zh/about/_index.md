...
我对博客的字体进行了比较任性的设置。中文部分使用的是[一點字坊](https://github.com/ichitenfont/)的[一點明體](https://github.com/ichitenfont/I.Ming/)，英文部分使用的是 [Amstelvar](https://github.com/TypeNetwork/Amstelvar/)，代码部分使用的是 [JetBrains Mono](https://www.jetbrains.com/lp/mono/)。另外，博客的评论系统由 [Waline](https://waline.js.org/) 提供，页脚的诗词显示功能使用了[今日诗词](https://www.jinrishici.com)的 API 接口。
