...
我对博客的字体进行了比较任性的设置。中文部分使用的是 Google Fonts 的[思源宋体](https://fonts.google.com/specimen/Noto+Serif+SC?subset=chinese-simplified)；[一點字坊](https://github.com/ichitenfont/)的[一點明體](https://github.com/ichitenfont/I.Ming/)；以及[落霞孤鹜 lxgw](https://github.com/lxgw) 的[霞鶩文楷](https://github.com/lxgw/LxgwWenkaiTC)。英文部分使用的是 [Amstelvar](https://github.com/TypeNetwork/Amstelvar/)。代码部分使用的是 [JetBrains Mono](https://www.jetbrains.com/lp/mono/)。另外，博客的评论系统由 [Waline](https://waline.js.org/) 提供。
